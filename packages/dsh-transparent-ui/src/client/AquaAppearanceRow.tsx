 ...
 * (`settings.general.item`, in the General page's main pane): every glass knob — mode
  ...
  return (
    <div className={css.group}>
      <header className={css.header}>
        <h2 className={css.title}>{t('aqua.title')}</h2>
        <p className={css.description}>{t('aqua.description')}</p>
      </header>
