...
describe('repository foundation', () => {
  it('declares the pinned Harness and release scripts', () => {
    ...
    expect(pkg.scripts.build).toMatch(/^pnpm --filter @deepseek-desktop\/connection build && pnpm --filter @deepseek-desktop\/transparent-ui bundle && pnpm --filter @deepseek-desktop\/host build/)
